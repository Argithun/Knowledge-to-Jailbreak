...
evaluate_harm('res_finance-chat.json')
evaluate_harm('res_gpt-3.5-1106.json')
evaluate_harm('res_gpt-4-1106.json')
evaluate_harm('res_law-chat.json')
evaluate_harm('res_llama-2-7b.json')
evaluate_harm('res_llama-2-13b.json')
evaluate_harm('res_Mistral-7B.json')
evaluate_harm('res_vicuna-7b.json')